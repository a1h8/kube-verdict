...
// ── score data (generated by tools/score.py) ──────────────────────────────────

const CATEGORIES    = SCORES_DATA.categories;
const SCORES_DATE   = new Date(SCORES_DATA.generated_at).toLocaleDateString("en-US", {
  ...
  return (
    <div style={{ ...T.section, borderBottom: "1px solid #1e293b" }}>
      <div style={T.wrap}>
        ...
        <p style={T.sub}>
          Computed by <code>tools/score.py</code> on each deploy — code quality,
          ops readiness, and business value. Last run: {SCORES_DATE}.
        </p>
